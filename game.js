...
let state = 'ready', y = CONFIG.canvasHeight / 2, velocity = 0, pipes = [], pipesMade = 0, groundOffset = 0, lastGapTop = 205, score = 0, bestScore = 0, secondsSinceCrash = 0, checkpoint = 0, currentMode = 'normal', lastTime = 0;
